import {
  to = segment_destination_subscription.id-63ae71063087c501ae2f775d_pp12g6eoXoQdWkJshNCpv6
  id = "63ae71063087c501ae2f775d:pp12g6eoXoQdWkJshNCpv6"
}

resource "segment_destination_subscription" "id-63ae71063087c501ae2f775d_pp12g6eoXoQdWkJshNCpv6" {
  ...
  trigger = "type = \"track\" or event = \"Order Completed\""
}