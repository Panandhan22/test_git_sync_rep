import {
  to = segment_destination_subscription.id-63ae71063087c501ae2f775d_cH5wpUJdSxmju999ooZYEF
  id = "63ae71063087c501ae2f775d:cH5wpUJdSxmju999ooZYEF"
}
...
resource "segment_destination_subscription" "id-63ae71063087c501ae2f775d_cH5wpUJdSxmju999ooZYEF" {
  ...
  trigger = "type = \"track\" and event = \"Subscription Purchased\""
}